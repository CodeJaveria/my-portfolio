  ...
  return (
    <section className="text-gray-600 body-font">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center md:gap-4 gap-4">
        ...
        <div
          className="lg:flex-grow md:w-1/2 lg:pl-6 flex flex-col md:items-start md:text-left 
        ...
        >
          ...
          <p className="mt-4 mb-8 leading-relaxed tracking-wider text-left md:text-justify max-w-[600px]">
            Hi! I am Javeria Sharif, a passionate Full Stack Website Developer with expertise in creating dynamic and responsive web applications. With a strong foundation in both front-end and back-end technologies, I specialize in building seamless user experiences and robust server-side functionalities. My skills include HTML, CSS, JavaScript, React, Node.js, Express, and MongoDB. I am dedicated to delivering high-quality code and innovative solutions to meet clients' needs. Let's collaborate to bring your web projects to life!
          </p>
